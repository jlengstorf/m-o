          ...
          <div className='columns is-multiline is-centered'>
            <div className='column is-12 has-text-centered'>
              <div style={{ position: 'relative' }}>
                <h1 className='title is-2 has-text-primary' style={{ margin: '3rem' }}>Neuigkeiten</h1>
            ...
            {posts && (posts
              .map(({ node: post }) => (
                ...
                >
                  <Fade>
                    <Entry style={{ padding: '0', boxShadow: '0 0 10px rgba(0,0,0,.9)', maxWidth: '300px', margin: '0 auto' }}>
                      <div style={{ position: 'relative' }}>
                        <Link className='title is-size-4' style={{ position: 'absolute', width: '100%', color: 'white', background: 'rgba(0,0,0,.9)', padding: '15px', overflow: 'hidden', zIndex: '2000' }} to={post.fields.slug}>
            ...
            <div className='column is-12 has-text-centered' style={{ marginTop: '3rem' }}>
              <Link to='/#news' className='button is-medium is-outlined is-primary'>
                zurück
              </Link>
            </div>
          </div>
